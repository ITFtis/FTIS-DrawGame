...
//    {
//        public const string AssemblyQualifiedName = "FtisDrawGame.Models.DepartmentSelectItemsClassImp, FtisDrawGame";
...
//    {
//        public const string AssemblyQualifiedName = "FtisDrawGame.Models.DepartmentSelectItemsClassImpForConsultRecord, FtisDrawGame";
...
//                    {
//                        _deps = fdb.Department.Where(s => s.DUse == "Y").ToArray();
//                        using (var db = new FtisDrawGame.Models.DouModelContextExt())
//                        {
